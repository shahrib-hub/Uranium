  ...
  return (
    <div className="glass p-10 rounded-[40px] ambient-red-border space-y-8">
      ...
      <div className="flex gap-8 items-center">
        <div className="w-32 h-32 rounded-3xl overflow-hidden shadow-2xl border border-white/10 group relative">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h2 className="text-3xl font-black truncate tracking-tight mb-1">{player.current.title}</h2>
          <p className="text-white/40 font-medium">by {player.current.author}</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 bg-white/5 p-3 rounded-2xl border border-white/10">
          ...
          <input 
            ...
            className="w-24 h-1 bg-white/10 rounded-full appearance-none cursor-pointer accent-red-500"
          />
        </div>
      </div>
    </div>
